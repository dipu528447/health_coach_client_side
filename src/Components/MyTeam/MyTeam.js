        ...
        <div>
             <section className="mb-20 text-gray-700">
                <div className="text-center md:max-w-xl lg:max-w-3xl mx-auto">
                    <h3 className="text-3xl font-bold mb-6 text-gray-800">My Team Members</h3>
                    <p className="mb-6 pb-2 md:mb-12 md:pb-0">
                    In my team i have experienced male and female health coach and gym trainer
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-6 lg:gap-12 text-center">
                    ...
                    <h6 className="font-semibold text-blue-600 mb-4">Yoga Trainer</h6>
                    <p className="mb-4">
                        <svg
                        aria-hidden="true"
                        focusable="false"
                    ...
                    <h6 className="font-semibold text-blue-600 mb-4">Gym Trainer</h6>
                    <p className="mb-4">
                        <svg
                        aria-hidden="true"
                        focusable="false"
                        ...
                        <path
                            fill="currentColor"
                            d="M464 256h-80v-64c0-35.3 28.7-64 64-64h8c13.3 0 24-10.7 24-24V56c0-13.3-10.7-24-24-24h-8c-88.4 0-160 71.6-160 160v240c0 26.5 21.5 48 48 48h128c26.5 0 48-21.5 48-48V304c0-26.5-21.5-48-48-48zm-288 0H96v-64c0-35.3 28.7-64 64-64h8c13.3 0 24-10.7 24-24V56c0-13.3-10.7-24-24-24h-8C71.6 32 0 103.6 0 192v240c0 26.5 21.5 48 48 48h128c26.5 0 48-21.5 48-48V304c0-26.5-21.5-48-48-48z"
                        ></path></svg>As a general goal, aim for at least 30 minutes of moderate physical activity every day. If you want to lose weight, maintain weight loss or meet specific fitness goals, you may need to exercise more. Reducing sitting time is important, too.
                    </p>
                    <ul className="flex justify-center mb-0">
                        <li>
                        <svg

...
const Footer = () => {
    return (
        <div>
            <footer className="text-center lg:text-left bg-black text-gray-300 mt-24">
                
                <div className="mx-auto py-10 text-center md:text-left container">
                ...
                <div className="text-center p-6 bg-black">
                    ...
                    <a className="text-gray-100 font-semibold" href="https://tailwind-elements.com/">Health Coach</a>
                </div>
                </footer>
        </div>
    );
